...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getAllBooking(long userId, BookingState state, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> getAllBookingForItems(Long userId, BookingState state, Integer from, Integer size) {
